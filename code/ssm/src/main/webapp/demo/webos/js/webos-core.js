...
appIcon_amg1 = appIcon_amg.extend({
	...
	create:function(){	
		...
		this.box.attr({
			...
			title:this.app.name + "tanfei", //tanfei
...
appIcon_t1 = appIcon_t0.extend({		
	...
	bindEvent:function(){//绑定事件(桌面图标)
		this.box.click(function(e){
			 ...
			 Windows.openApp(id,title,url,icon,'100%','100%');	
		});
	}
});

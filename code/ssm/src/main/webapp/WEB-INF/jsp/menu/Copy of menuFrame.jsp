					...
					<tr>
						...
						<!-- 主体 start -->
							<div style="width:100%;height:100%;">
								...
								<div style="float:right;width:80%;height:600px;">
									<iframe name="rightFrame" id="rightFrame" src="menu/menuList.do" style="margin:0px;" frameborder="0" width="100%" height="100%"></iframe>
								</div>
							</div>
						<!-- 主体 end -->

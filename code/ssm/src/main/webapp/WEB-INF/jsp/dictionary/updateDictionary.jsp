	            ...
	            <table width="100%" style="table-layout:fixed;padding-left: 10px;" border="0">
	            	<tr>
	                    ...
	                    <td style="width:205px;">
	                    	...
	                    	<input type="text" value="${dictionary.name}" name="name" 
	            	...
	            	<tr>
	                    ...
	                    <td style="width:205px;">
	                    	<input type="text" value="${dictionary.dicKey}" name="dicKey" 
	            	...
	            	<tr>
	                    ...
	                    <td style="width:205px;">
	                    	<input type="text" value="${dictionary.value}" name="value" 
	            	...
	            	<tr>
	                	...
	                	<td>
	                		<select name="status" datatype="*" nullmsg="请选择状态！" class="Validform_error">
	                			...
	                			<c:if test="${dictionary.status == '启用'}">
	                				<option value="启用" selected>启用</option>
	                				<option value="禁用">禁用</option>
	                			</c:if>
	                			<c:if test="${dictionary.status == '禁用'}">
	            	...
	            	<tr>
	                    ...
	                    <td style="width:205px;">
	                    	<textarea rows="3" cols="10" name="remark">${dictionary.remark}</textarea>
	                    </td>
	                    <td><div class="Validform_checktip"></div></td>
	            	</tr>
	                <tr>
	...
	$(function(){
		...
		function callback(form){
			top.art.dialog.confirm('你确定要提交吗？', function () {
				$.ajax({
					type: "POST",
					url: "dictionary/ajaxUpdateDictionary.do",
					...
					success: function(data)
					{
						if("y" == data.status)
						{
							...
							top.art.dialog({id: 'updateDictionary'}).close();

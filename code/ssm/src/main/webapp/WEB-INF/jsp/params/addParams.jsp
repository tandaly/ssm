	        ...
	        <form id="form" name="form" class="registerform" action="" onsubmit="return false;" method="post">
	            <table width="100%" style="table-layout:fixed;padding-left: 10px;" border="0">
	            	<tr>
	            		...
	            		<td style="width:70px;">名&nbsp;&nbsp;称：</td>
	                    <td style="width:205px;">
	                    	<input type="text" value="" name="name" ajaxurl="params/ajaxFormParamsName.do"
	                    		class="inputxt"  datatype="*1-50" nullmsg="请输入名称！" errormsg="名称范围在1~50位之间！" /></td>
	                    <td><div class="Validform_checktip">大写英文,单词之间用下划线分隔</div></td>
	            	</tr>
	            	<tr>
	            		<td class="need" style="width:10px;">*</td>

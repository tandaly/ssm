...
import com.tanf.core.util.json.JSONUtil;
...
public class KindEditorController {
	...
	public void fileUpload(HttpServletRequest request,
		...
		String savePath = application.getRealPath("/") + "attached/kindeditor/" + user.getId() + "/";

		// 文件保存目录URL
		String saveUrl = request.getContextPath() + "/attached/kindeditor/" + user.getId() + "/";
	...
	private void writeJson(HttpServletResponse response, Object msg)
	{
        ...
        try {
            ...
            try
			{
				writer.println(JSONUtil.toJSONString(msg));
	...
	public void fileManager(HttpServletRequest request,
		...
		String rootPath = application.getRealPath("/") + "/attached/kindeditor/" + user.getId() + "/";
		// 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
		String rootUrl = request.getContextPath() + "/attached/kindeditor/" + user.getId() + "/";
		// 图片扩展名
		...
		try
		{
			msgStr = JSONUtil.toJSONString(msg);
		} catch (JSONException e)
		{
			e.printStackTrace();
		}
